...
> **Обновлено:** 2026-09-25 ~18:03 MSK · seals до 25.09; Phase C NO_GO; collect; wake_arm double-fork.  
...
### Состояние на 2026-09-25 EOD (~18:03 MSK)

| Метрика | Значение |
|--------|----------|
| **Phase A** | **done** 25–28.08 + full **15.09**. Extra sealed: 01–04.09, 07–11.09, 14/16–18/21–**25.09** |
| **OOS cumulative** | **50** Exclusive, **+16 104 ₽**, expectancy **~322 ₽/trade**, WR **74%**, labeled SL 100% |
| **25.09** | **−259 ₽** · 1× BUY BOUNCE SL/THROUGH · EOD optional · **не крутить гейты** |
| **24.09** | **0** сделок · weak day |
| **23.09** | **−224 ₽** · 1× SELL BOUNCE SL/SWEEP · smash gateHit=1 |
| **22.09** | **+707 ₽** · 3/0 |
| **15.09** | **+7 021 ₽** · 6 сделок · full observe |
| **Corpus** | Exclusive ~8485 events · 31 decision days · armFill ~109 · ML collecting |
| **Front** | **BRV6** · exp 2026-10-01 (~6d) |
...
**Следующая сессия:** `bash IMOEX/scripts/trend_observe_resume.sh` (~09:55 next trade day, обычно пн); evening ~18:02. Не крутить гейты. ML/FORTS — только явный go.
