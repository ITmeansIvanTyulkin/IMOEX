...
/**
 * Операторский API: статус автопрогонов и алерты paper.
 */
@RestController
...
public class OpsController {
    ...
    public OpsController(PaperAlertService alertService, ImoexProperties properties) {
    ...
    /**
     * GET /api/ops/paper-alerts — новые OPEN за последние 24ч (клиент дедуплицирует по id).
     */
